...
#include "etherdreamplugin.h"
#include "configureetherdream.h"
...
EtherdreamPlugin::~EtherdreamPlugin()
{
}

void EtherdreamPlugin::init()
{
...
QString EtherdreamPlugin::name()
{
    return QString("Etherdream");
}

int EtherdreamPlugin::capabilities() const
{
    return QLCIOPlugin::Output | QLCIOPlugin::Input | QLCIOPlugin::Feedback | QLCIOPlugin::Infinite;
}

QString EtherdreamPlugin::pluginInfo()
{
    QString str;
...
bool EtherdreamPlugin::requestLine(quint32 line, int retries)
{
    int retryCount = 0;
 ...
 * Outputs
 *********************************************************************/
QStringList EtherdreamPlugin::outputs()
{
    QStringList list;
    int j = 0;
...
QString EtherdreamPlugin::outputInfo(quint32 output)
{
...
bool EtherdreamPlugin::openOutput(quint32 output, quint32 universe)
{
...
void EtherdreamPlugin::closeOutput(quint32 output, quint32 universe)
{
    if (output >= (quint32)m_IOmapping.length())
        return;
...
void EtherdreamPlugin::writeUniverse(quint32 universe, quint32 output, const QByteArray &data)
{
...
/*************************************************************************
  * Inputs
  *************************************************************************/
QStringList EtherdreamPlugin::inputs()
{
    QStringList list;
    int j = 0;
...
bool EtherdreamPlugin::openInput(quint32 input, quint32 universe)
{
...
void EtherdreamPlugin::closeInput(quint32 input, quint32 universe)
{
...
QString EtherdreamPlugin::inputInfo(quint32 input)
{
    if (input >= (quint32)m_IOmapping.length())
        return QString();
...
void EtherdreamPlugin::sendFeedBack(quint32 universe, quint32 input,
 ...
 * Configuration
 *********************************************************************/
void EtherdreamPlugin::configure()
{
    ConfigureEtherdream conf(this);
    conf.exec();
}

bool EtherdreamPlugin::canConfigure()
{
    return true;
}

void EtherdreamPlugin::setParameter(quint32 universe, quint32 line, Capability type,
...
QList<OSCIO> EtherdreamPlugin::getIOMapping()
{
    return m_IOmapping;
}
...
Q_EXPORT_PLUGIN2(EtherdreamPlugin, EtherdreamPlugin)
#endif
