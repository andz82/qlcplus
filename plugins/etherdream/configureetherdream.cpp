...
ConfigureEtherdream::ConfigureEtherdream(EtherdreamPlugin* plugin, QWidget* parent)
        : QDialog(parent)
{
...
ConfigureEtherdream::~ConfigureEtherdream()
{
}

void ConfigureEtherdream::fillMappingTree()
{
...
void ConfigureEtherdream::showIPAlert(QString ip)
{
...
void ConfigureEtherdream::accept()
{
...
void ConfigureEtherdream::slotOSCPathChanged(QString path)
{
    m_chNumSpin->setValue(qChecksum(path.toUtf8().data(), path.length()));
}

int ConfigureEtherdream::exec()
{
    return QDialog::exec();
}
